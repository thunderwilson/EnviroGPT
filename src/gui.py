...
def ui_info():
	...
	""")
	ui_spacer(1)
	st.write("Made by [Tom Wilson](https://www.linkedin.com/in/tdgwilson/).", unsafe_allow_html=True)
	ui_spacer(1)
	st.markdown("""
	...
	st.markdown("""
		...
		""")
	ui_spacer(1)
	#st.markdown('Source code can be found [here](https://github.com/thunderwilson/ask-my-pdf).')
